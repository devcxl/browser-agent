          ...
          await llmClient.chatStream(
            {
              ...
              messages,
              tools,
              max_tokens: input.modelConfig?.defaults?.maxOutputTokens,
              temperature: input.modelConfig?.defaults?.temperature,
              reasoning_effort: input.reasoningEffort ?? this.config.reasoningEffort,
            },
            streamChunkHandler,
